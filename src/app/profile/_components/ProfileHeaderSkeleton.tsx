    ...
    >
      ...
      <div className="relative flex items-center gap-2 md:gap-8">
        ...
        <div className="relative">
          ...
          <div className="size-16 md:size-24 rounded-full bg-gray-800/80 animate-pulse relative z-10 border-4 border-gray-800/50" />
          <div
            className="absolute -top-1 -right-1 w-8 h-8 bg-gradient-to-r from-purple-500/50 
