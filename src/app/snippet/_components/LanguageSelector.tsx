  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className={`group relative flex items-center gap-3 px-2 py-1.5 bg-[#1e1e2e]/80 
      ...
      >
        ...
        <span className="text-gray-200 min-w-[64px] text-left group-hover:text-white transition-colors">
