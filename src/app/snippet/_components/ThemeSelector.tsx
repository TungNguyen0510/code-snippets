  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="w-44 group relative flex items-center gap-2 px-2 py-1.5 bg-[#1e1e2e]/80 hover:bg-[#262637] 
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            backdrop-blur-xl rounded-xl border border-[#313244] shadow-2xl py-2 z-50 overflow-hidden"
          >
